...
EmailQueue is a base Extra template that is useful when wanting to create a new
...
`git clone http://github.com/bezumkin/EmailQueue.git ./`

Then, create the target directory where you want to create the file.

Then, navigate to the directory EmailQueue is now in, and do this:
...
Now, you'll want to change references to EmailQueue in the files in your
new copied-from-EmailQueue repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'EmailQueue' to whatever the
