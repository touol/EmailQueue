...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('emailqueue_core_path', null,
                    $modx->getOption('core_path') . 'components/emailqueue/') . 'model/';
            $modx->addPackage('emailqueue', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/emailqueue/model/schema/emailqueue.mysql.schema.xml';
